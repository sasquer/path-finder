...
import 'package:path_finder/core/logging/console_logger.dart';
...
void configureDependencies() {
  getIt
    ...
    ..registerLazySingleton<ApiClient>(
      () => HttpApiClient(getIt(), logger: const ConsoleLogger('HTTP')),
    )
    ...
    ..registerLazySingleton<TasksRepository>(
      () => TasksRepositoryImpl(getIt(), logger: const ConsoleLogger('Tasks')),
    )
    ..registerLazySingleton<PathSolver>(
      () => const IsolatePathSolver(logger: ConsoleLogger('PathSolver')),
    )
